    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.posts.store')}}" id="form-create-post">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <select class="form-control" name="currency_salary">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-create-company" action="{{route('admin.companies.store')}}" method="POST"
        ...
        async function loadDistrict(parent) {
            ...
            $.each(districts.district, function (index, each) {
                if (each.pre === 'Quận' || each.pre === 'Huyện') {
                    string += `<option`;
                    if (selectedValue === each.pre + " " + each.name) {
                        string += ` selected `;
                    }
